...
//
//  Created by Swift Algorithm Club / raywenderlich.com community
...
public final class DoublyLinkedList<T> {
    ...
    /// Append a copy of a DoublyLinkedList to the end of the list.
    ///
    ...
    /// Insert a copy of a DoublyLinkedList at a specific index. Crashes if index is out of bounds (0...self.count)
    ///
    /// - Parameters:
    ///   - list: The DoublyLinkedList to be copied and inserted
    ///   - index: Integer value of the index to be inserted at
